# -*- coding: utf-8 -*-
#
# gs.profile.notify documentation build configuration file, created by
# sphinx-quickstart on Wed Jun 24 10:00:30 2015.
#
...
htmlhelp_basename = 'gsprofilenotifydoc'
...
latex_documents = [
  (master_doc, 'gsprofilenotify.tex', u'gs.profile.notify Documentation',
...
man_pages = [
    (master_doc, 'gsprofilenotify', u'gs.profile.notify Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'gsprofilenotify', u'gs.profile.notify Documentation',
   author, 'gsprofilenotify', 'One line description of project.',
   'Miscellaneous'),
]
